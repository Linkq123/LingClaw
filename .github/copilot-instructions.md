...
- Dependencies: axum, tokio, serde, serde_json, reqwest, futures, regex, tower-http, tokio-util, chrono, base64. Do not add more without justification.
