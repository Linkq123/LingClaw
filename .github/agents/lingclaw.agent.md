...
- `src/runtime_loop.rs` — phase-execution loop, fast-model routing, parallel read-only tool execution, post-execution reflection, planning/finish nudge injection, tool progress dispatch
