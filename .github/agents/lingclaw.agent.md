...
- `src/memory.rs` — structured async memory (schema, queue, merge, prompt injection, `/memory` command)
...
- `src/tools/mod.rs` — built-in tool registry and schema-aware argument validation
