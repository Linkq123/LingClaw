...
const STRINGS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'session.edit': 'Edit {name}',
    'session.workspaceMeta': '{id} · {workspace}',
    'session.workspaceUnavailable': 'directory unavailable',
    ...
    'dialog.createSessionTitle': 'Create session',
    'dialog.editSessionTitle': 'Edit session',
    ...
    'dialog.workspaceLabel': 'Working directory',
    'dialog.workspaceManaged': 'LingClaw managed',
    'dialog.workspaceManagedHint': 'Use a private working directory under the LingClaw home.',
    'dialog.workspaceDirectory': 'Local directory',
    'dialog.workspaceDirectoryHint':
      'Run file, shell, Git, image and plan tools in an existing project.',
    'dialog.workspacePath': 'Directory path',
    'dialog.workspacePathPlaceholder': 'Choose an existing absolute directory',
    'dialog.workspaceBrowse': 'Browse',
    'dialog.workspaceBrowsing': 'Loading…',
    'dialog.workspaceParent': 'Parent',
    'dialog.workspaceHome': 'Home',
    'dialog.workspaceNoDirectories': 'No child directories.',
    'dialog.workspacePathRequired': 'Choose an existing working directory.',
    'dialog.workspaceBrowseError': 'Cannot browse this directory: {error}',
    'dialog.workspaceBroadConfirm':
      'I understand this broad directory exposes many files to Agent tools.',
    'dialog.workspaceBroadRequired': 'Confirm the broad directory before continuing.',
    ...
    'dialog.createSessionAction': 'Create session',
    ...
    'composer.imageModelUnsupported': 'The current model does not support image input.',
    'composer.imageStorageUnavailable': 'Configure S3 before uploading images.',
    'composer.removeImage': 'Remove image',
    'composer.executeMode': 'Execute',
    'composer.planMode': 'Plan',
    'composer.cancelPlanMode': 'Cancel Plan mode',
    ...
    'composer.noModelsFound': 'No matching models.',
    'composer.chooseEffort': 'Choose thinking effort',
    'composer.backToModels': 'Back to models',
    'composer.groupModelPickerUnsupported': 'Group members use their own configured models.',
    'composer.modelSwitchRunning': 'Stop the current Agent run before switching models.',
    'composer.modelSwitchUploading': 'Wait for the image upload to finish.',
    'composer.modelSwitchSessionChanging': 'Wait for the Session change to finish.',
    'composer.modelSwitchSaving': 'Saving model selection...',
    'composer.modelSelectionUnavailable':
      'This model is no longer available. Refresh the model list and choose another model.',
    'composer.effortSelectionUnsupported':
      'This thinking effort is no longer supported by the selected model.',
    'composer.modelSessionUnavailable': 'This Session is no longer available.',
    'composer.modelCatalogError': 'Could not load models: {error}',
    'composer.modelSelectionError': 'Could not change the model: {error}',
    'composer.modelCatalogChanged': 'Model configuration changed while loading. Retrying failed.',
    ...
    'plan.completionChecks': 'Server completion checks',
    'plan.completion.workspacePath': 'Final workspace path {path}: {expectation}',
    'plan.completion.evidence': 'Approved {kind} evidence remains unchanged: {path}',
    'plan.completion.progress': 'Original steps completed or skipped: {steps}',
    'plan.completion.tool': 'Exact successful tool call: {tool}',
    'plan.completion.path.file': 'file',
    'plan.completion.path.directory': 'directory',
    'plan.completion.path.absent': 'absent',
    'plan.completion.size': 'size {size} bytes',
    'plan.completion.content': 'exact content {content}',
    'plan.completion.sha256': 'SHA-256 {hash}',
    ...
    'settings.field.enableGroups': 'Enable Group Chat',
  ...
  'zh-CN': {
    ...
    'session.edit': '编辑 {name}',
    'session.workspaceMeta': '{id} · {workspace}',
    'session.workspaceUnavailable': '目录不可用',
    ...
    'dialog.createSessionTitle': '新建会话',
    'dialog.editSessionTitle': '编辑会话',
    ...
    'dialog.workspaceLabel': '工作目录',
    'dialog.workspaceManaged': 'LingClaw 托管',
    'dialog.workspaceManagedHint': '使用 LingClaw 主目录内的私有工作目录。',
    'dialog.workspaceDirectory': '本机目录',
    'dialog.workspaceDirectoryHint': '文件、Shell、Git、图片和计划工具将在现有项目中运行。',
    'dialog.workspacePath': '目录路径',
    'dialog.workspacePathPlaceholder': '选择一个现存的绝对目录',
    'dialog.workspaceBrowse': '浏览',
    'dialog.workspaceBrowsing': '加载中…',
    'dialog.workspaceParent': '上一级',
    'dialog.workspaceHome': '主目录',
    'dialog.workspaceNoDirectories': '没有子目录。',
    'dialog.workspacePathRequired': '请选择一个现存的工作目录。',
    'dialog.workspaceBrowseError': '无法浏览此目录：{error}',
    'dialog.workspaceBroadConfirm': '我了解此宽泛目录会向 Agent 工具暴露大量文件。',
    'dialog.workspaceBroadRequired': '继续前请确认此宽泛目录。',
    ...
    'dialog.createSessionAction': '创建会话',
    'dialog.working': '处理中…',
    ...
    'composer.imageModelUnsupported': '当前模型不支持图片输入。',
    'composer.imageStorageUnavailable': '请先配置 S3，再上传图片。',
    'composer.removeImage': '移除图片',
    'composer.executeMode': '执行',
    'composer.planMode': '规划',
    'composer.cancelPlanMode': '取消规划模式',
    ...
    'composer.noModelsFound': '没有匹配的模型。',
    'composer.chooseEffort': '选择思考强度',
    'composer.backToModels': '返回模型列表',
    'composer.groupModelPickerUnsupported': '群成员分别使用各自配置的模型。',
    'composer.modelSwitchRunning': '请先停止当前 Agent 任务，再切换模型。',
    'composer.modelSwitchUploading': '请等待图片上传完成。',
    'composer.modelSwitchSessionChanging': '请等待 Session 切换完成。',
    'composer.modelSwitchSaving': '正在保存模型选择...',
    'composer.modelSelectionUnavailable': '此模型已不可用，请刷新模型列表后重新选择。',
    'composer.effortSelectionUnsupported': '所选模型已不再支持此思考强度。',
    'composer.modelSessionUnavailable': '当前 Session 已不可用。',
    'composer.modelCatalogError': '加载模型失败：{error}',
    'composer.modelSelectionError': '切换模型失败：{error}',
    'composer.modelCatalogChanged': '加载期间模型配置已变化，重试仍未成功。',
    ...
    'plan.completionChecks': '服务端完成检查',
    'plan.completion.workspacePath': '最终工作区路径 {path}：{expectation}',
    'plan.completion.evidence': '批准时的 {kind} 证据保持不变：{path}',
    'plan.completion.progress': '原始步骤已完成或明确跳过：{steps}',
    'plan.completion.tool': '精确工具调用成功：{tool}',
    'plan.completion.path.file': '文件',
    'plan.completion.path.directory': '目录',
    'plan.completion.path.absent': '不存在',
    'plan.completion.size': '大小 {size} 字节',
    'plan.completion.content': '精确内容 {content}',
    'plan.completion.sha256': 'SHA-256 {hash}',
    'plan.deviation': '偏离原因',
    'plan.execute': '执行计划',
    ...
    'settings.field.enableGroups': '启用群聊',
