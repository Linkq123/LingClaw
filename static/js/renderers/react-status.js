...
import {
  MIN_REACT_ANALYZE_VISIBLE_MS, MIN_REACT_ACT_VISIBLE_MS,
  MIN_REACT_OBSERVE_VISIBLE_MS, MAX_REACT_QUEUED_PHASES
} from '../constants.js';
...
export function renderReactStatus() {
  ...
  cycle.textContent = Number.isInteger(state.reactStatusCycle) ? `cycle ${state.reactStatusCycle}` : '';
